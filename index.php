    ...
    <body>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        ...
                        <a href="https://forms.gle/8FqE1tvvAAT6yUqF7">
        ...
        <div id="servers" class="container-fluid text-center">
            <div class="row">
                <div class="col-sm-6">
                    <div class="server">
                        <div id="ts3viewer_1126151" style="width:auto; height:500px; "></div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="server">
