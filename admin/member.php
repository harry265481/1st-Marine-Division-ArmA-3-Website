        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 bg-dark">
                    <img class="mx-auto d-block"  width="70%." src="data:image/png;base64,<?php echo generateUniform($_GET['id'], getMemberGrade($_GET['id']), getMemberBranchID($_GET['id']), "../", getMemberArmyBranchID($_GET['id'])); ?>" />
