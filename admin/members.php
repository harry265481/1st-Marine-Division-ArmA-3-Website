            ...
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 bg-dark">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <h1></h1>
                        <a href="addmember.php"><button type="button" class="btn btn-outline-success">Add Member</button></a>
                        <a href="massaward.php"><button type="button" class="btn btn-outline-success">Mass Award</button></a>
